...
-**MX2021011098** - INSTRUMENTO MEDIDOR DE VARIABLES FISICOQUIMICAS Y GASES PARA SUELOS..

 -**Fecha de publicación**: 13.09.2021

-**Número de publicación**:20210111098

-**Inventor(es)**: Stephania Guadalupe Lázaro Mass , Sergio Alberto Gómez Cornelio , Sandra de Jesús Hernández Nataren , Fanny Guadalupe Jauregui González . 

 El instrumento medidor de variables fisicoquímicas y gases para tiene su campo de aplicación en el sector agrícola, combina todas las variables que otros dispositivos miden por separado, además tiene dimensiones y peso adecuados para manipulación en campo, consta de baterías recargables con ayuda de un dispositivo que capta la energía térmico - lumínica del sol para convertirla en energía eléctrica que evitan el uso constante de baterías externas y el riesgo de detener las mediciones por baja carga. Entre las variables que mide se encuentran: pH, salinidad con sensor de conductividad eléctrica, respiración microbiana con sensor de los gases CO2, NOx y CO, humedad del sustrato, humedad y temperatura ambiente, luz ultravioleta e intensidad lumínica Está constituido por conectores macho de al menos 3 pines, dos módulos con conector hembra para electrodos de pH y conductividad, múltiples sensores para la medición de variables agrícolas, carcasa liviana de bordes redondeados, interruptor de encendido/apagado, modulo para almacenamiento de datos y sistema de calibración integrado. Caracterizado por baterías recargables que se alimentan con ayuda de un dispositivo que convierte la energía solar en energía eléctrica y una interfaz con pantalla táctil.
