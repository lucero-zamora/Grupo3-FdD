...
Este artículo analiza el uso de redes de sensores inalámbricos (WSN) para el monitoreo de la humedad del suelo en agricultura de precisión. Revisa las técnicas empleadas para la medición de la humedad del suelo y el desarrollo de conjuntos de sensores de bajo costo para determinar los niveles de contaminación en las fuentes de agua.(1)


### Artículo 2
### Diseño de Red de Sensores Inalámbricos para Monitoreo de Parámetros de Calidad del Suelo.

El artículo describe el diseño e implementación de la red de sensores inalámbricos, incluyendo la configuración de los nodos sensores y los métodos utilizados para la adquisición y transmisión de datos. También se discuten los resultados obtenidos a partir del monitoreo de los parámetros del suelo y se analiza la utilidad de la red de sensores inalámbricos en la detección temprana de problemas de contaminación o degradación del suelo. Además, se mencionan posibles aplicaciones y beneficios adicionales de esta tecnología, como la optimización de la gestión misma.[2]
...
Este artículo de revisión presenta el estado actual de la tecnología de red de sensores inalámbricos para la detección distribuida y casi en tiempo real de la humedad del suelo. Enfatiza la importancia del monitoreo en tiempo real de la humedad del suelo para optimizar la producción agrícola y el uso de los recursos hídricos.(3)
...
Este estudio revisa el potencial de los métodos de espectroscopia y los sensores de observación de la Tierra para evaluar contaminantes del suelo seleccionados. Se centra en el uso de información espectral procedente de técnicas de detección próxima y remota para modelar la contaminación del suelo.(4)
